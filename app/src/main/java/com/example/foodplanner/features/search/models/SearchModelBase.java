...
public class SearchModelBase<T extends Parcelable> {
    protected final Flowable<List<T>> data;
    private final String key;

    public SearchModelBase(Bundle savedInstanceState, String key, Single<? extends RemoteModelWrapper<T>> remoteSource) {
        this.key = key;
